...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_dependency(%q<actionpack>.freeze, ["= 5.2.8.1"])
    s.add_dependency(%q<actionview>.freeze, ["= 5.2.8.1"])
    s.add_dependency(%q<activemodel>.freeze, ["= 5.2.8.1"])
    s.add_dependency(%q<activerecord>.freeze, ["= 5.2.8.1"])
    s.add_dependency(%q<actionmailer>.freeze, ["= 5.2.8.1"])
    s.add_dependency(%q<activejob>.freeze, ["= 5.2.8.1"])
    s.add_dependency(%q<actioncable>.freeze, ["= 5.2.8.1"])
    s.add_dependency(%q<activestorage>.freeze, ["= 5.2.8.1"])
    s.add_dependency(%q<railties>.freeze, ["= 5.2.8.1"])
